...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "name": "description",
        "content": "Find Top Vocational Courses Colleges in India based on  ranking with details on courses, fees, placements, admission, reviews, cut off, and latest news."
      },
      {
        "property": "og:type",
        "content": "website"
      ...
      {
        "property": "og:title",
        "content": "Top Vocational Courses Colleges in India 2025: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/vocational-courses-colleges"
      },
      {
      ...
      },
      {
        ...
        "content": "Top Vocational Courses Colleges in India: Check ranking, placement, fees, admission, cutoff, eligibility, and latest news."
      },
      {
    ...
    "links": [
      ...
      {
        "href": "/vocational-courses-colleges",
        "rel": "canonical"
      },
      {
  ...
  return (
    <>
          ...
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              <h1 className={"college__Landing__Hero__Section__Heading"}>
                {"Top Vocational Courses Colleges in India 2026"}
              </h1>
            </div>
          </div>
        </div>
          ...
          <div className={"col-md-6 mobile__white__bg"}>
            <div className={"filter__selected__container"}>
              <div id={"selectedFilters"} className={"filterDiv"}>
                <button id={"vocational-courses"} data-attr={"stream"} className={"filter__selected"}>
                  {"Vocational Courses"}
            ...
            <div className={"filtered__colleges__list"}>
              <div className={"searchedcollegeList"}>
                    <div className={"college__card__new "} key={"NS20"} id={"search-NS20"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            ...
                            alt={"National Skill Training Institute (NSTI-W), Panipat"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NS20")} title={"National Skill Training Institute (NSTI-W), Panipat"}>
                                {"National Skill Training Institute (NSTI-W), Panipat"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"National Skill Training Institute (NSTI-W), Panipat Reviews"} href={allowedLink("/reviews")}>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"National Skill Training Institute (NSTI-W), Panipat is a top accredited Government institute located in Panipat, Haryana. Code: NS20."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"National Skill Training Institute (NSTI-W), Panipat Courses"}>
                                  {"8 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"National Skill Training Institute (NSTI-W), Panipat"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"National Skill Training Institute (NSTI-W), Panipat"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"GO89"} id={"search-GO89"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Govt. IToT, Jaipur, Rajasthan"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/GO89")} title={"Govt. IToT, Jaipur, Rajasthan"}>
                                {"Govt. IToT, Jaipur, Rajasthan"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Govt. IToT, Jaipur, Rajasthan Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Govt. IToT, Jaipur, Rajasthan is a top accredited Government institute located in Jaipur, Rajasthan. Code: GO89."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Govt. IToT, Jaipur, Rajasthan Courses"}>
                                  {"6 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Govt. IToT, Jaipur, Rajasthan"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Govt. IToT, Jaipur, Rajasthan"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"NSTI-MUM"} id={"search-NSTI-MUM"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"NSTI Mumbai (Vocational Training), Mumbai"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NSTI-MUM")} title={"NSTI Mumbai (Vocational Training), Mumbai"}>
                                {"NSTI Mumbai (Vocational Training), Mumbai"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"NSTI Mumbai (Vocational Training), Mumbai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"NSTI Mumbai (Vocational Training), Mumbai is a top accredited Government institute located in Mumbai, Maharashtra. Code: NSTI-MUM."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"NSTI Mumbai (Vocational Training), Mumbai Courses"}>
                                  {"12 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"NSTI Mumbai (Vocational Training), Mumbai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"NSTI Mumbai (Vocational Training), Mumbai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"NSTI-KOL"} id={"search-NSTI-KOL"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"NSTI Kolkata (Vocational Training), Kolkata"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NSTI-KOL")} title={"NSTI Kolkata (Vocational Training), Kolkata"}>
                                {"NSTI Kolkata (Vocational Training), Kolkata"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"NSTI Kolkata (Vocational Training), Kolkata Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"NSTI Kolkata (Vocational Training), Kolkata is a top accredited Government institute located in Kolkata, West Bengal. Code: NSTI-KOL."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"NSTI Kolkata (Vocational Training), Kolkata Courses"}>
                                  {"10 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"NSTI Kolkata (Vocational Training), Kolkata"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"NSTI Kolkata (Vocational Training), Kolkata"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"NSTI-BBL"} id={"search-NSTI-BBL"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"NSTI Bengaluru, Bengaluru"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NSTI-BBL")} title={"NSTI Bengaluru, Bengaluru"}>
                                {"NSTI Bengaluru, Bengaluru"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"NSTI Bengaluru, Bengaluru Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"NSTI Bengaluru, Bengaluru is a top accredited Government institute located in Bengaluru, Karnataka. Code: NSTI-BBL."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"NSTI Bengaluru, Bengaluru Courses"}>
                                  {"11 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"NSTI Bengaluru, Bengaluru"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"NSTI Bengaluru, Bengaluru"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <div className={"desktopOnly getSupport college-filter-get-support"}>
        <div className={"brochureBtn filter-college-scholership leadFilterData predict-my-college-cta"} data-filter={"college-listing"} data-entity={"college"} data-lead_cta={"22"} data-stream={"vocational-courses"} data-ctalocation={"colleges_listing_card_predict_my_college"}></div>
      </div>
...
export default function VocationalPage({ onNavigate }) {
  return (

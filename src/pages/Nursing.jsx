...
function NursingContent() {
  ...
  const filteredColleges = useMemo(() => {
    return nursingCollegesData.filter(college => {
      // State filter
          ...
          <div className={"col-md-3 lg-pr-0"}>
            <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs mb-6 sticky top-24">
              ...
              <div className="mb-5">
                ...
                >
                  <option value="all">All States ({nursingCollegesData.length})</option>
                  {statesList.map(st => (
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="Search 1,811 Nursing Colleges by name, city, state..."
                ...
                <div className="flex items-center gap-2 flex-wrap text-xs">
                  <span className="font-bold text-slate-700">
                    Showing <strong className="text-[#0966c2]">{filteredColleges.length}</strong> of {nursingCollegesData.length} Colleges
                  </span>
                  {selectedState !== 'all' && (
            ...
            <div className="space-y-4">
              {displayedColleges.length === 0 ? (
                <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center shadow-xs">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-1">No Nursing Colleges Found</h3>

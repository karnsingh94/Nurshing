...
import { yogaCollegesData } from '../data/yogaCollegesData.js';
...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "property": "og:title",
        "content": "Top Yoga & Naturopathy Colleges in India 2026: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/yoga"
...
function YogaContent({ onNavigate }) {
  ...
  const filteredColleges = useMemo(() => {
    return yogaCollegesData.filter(college => {
      // State filter
        ...
        <div className={"college__Landing__New"}>
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              ...
              <h2>
                <strong>
                  {"Top Yoga & Naturopathy Colleges in India by NIRF"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Top Yoga & Naturopathy Colleges in India by India Today"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Top Yoga & Naturopathy Colleges in India Based on Zones"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Specialisations-wise Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Fee Structure for Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Entrance Exams Accepted by Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Admissions and Eligibility Criteria for Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h3>
                <strong>
                  {"Eligibility Criteria for Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h3>
              <p>
                <span>
              ...
              <h3>
                <strong>
                  {"Admissions to Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h3>
              <p>
                <span>
              ...
              <h2>
                <strong>
                  {"Cut Offs for Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h2>
              <p>
                <span>
              ...
              <h3>
                <strong>
                  {"Average Salary Offered in Top Yoga & Naturopathy Colleges in India"}
                </strong>
              </h3>
              <p>
                <span>
          ...
          <div className={"col-md-3 lg-pr-0"}>
            <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs mb-6 sticky top-24">
              ...
              <div className="mb-5">
                ...
                >
                  <option value="all">All States ({yogaCollegesData.length})</option>
                  {statesList.map(st => (
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="Search Yoga & Naturopathy Colleges by name, city, state..."
                ...
                <div className="flex items-center gap-2 flex-wrap text-xs">
                  <span className="font-bold text-slate-700">
                    Showing <strong className="text-[#0966c2]">{filteredColleges.length}</strong> of {yogaCollegesData.length} Colleges
                  </span>
                  {selectedState !== 'all' && (
            ...
            <div className="space-y-4">
              {displayedColleges.length === 0 ? (
                <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center shadow-xs">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-1">No Yoga & Naturopathy Colleges Found</h3>
                      ...
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-xs text-slate-500 font-medium">
                            ...
                            <span className="flex items-center gap-1">
                              🎓 <strong className="text-slate-700 font-semibold">{college.courses || 'BNYS, B.Sc Yoga Science, M.Sc Yoga, Diploma in Yoga'}</strong>
                            </span>
                          </div>
...
export default function YogaPage({ onNavigate }) {
  return (
    <PageRenderer page={page} onNavigate={onNavigate}>
      <YogaContent onNavigate={onNavigate} />
    </PageRenderer>
  );
}
